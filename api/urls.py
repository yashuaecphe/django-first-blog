...
urlpatterns = [
    path('blogposts/', BlogFeed.as_view(), name='blogs'), # GET list of blogposts or POST a new one
    path('blogpost/<int:pk>/', BlogDetail.as_view(), name='blog'), #GET, PUT, or DELETE a single blogpost
